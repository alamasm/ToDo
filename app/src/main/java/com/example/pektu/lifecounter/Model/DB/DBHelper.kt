...
class DBHelper(context: Context) : SQLiteOpenHelper(context, DB_NAME, null, CURRENT_VERSION) {
    ...
    companion object {
        ...
        val ALL_PLANS_COLUMNS = listOf("id", "plan", "hours", "minutes", "done", "date", "doing", "spent_hours",
                "spent_minutes", "create_date", "start_doing_date", "last_notification_time", "undone",
                "moved", "new_plan_id", "spent_time_before_move", "spent_time_before_pause").toTypedArray()
        ...
        private const val CREATE_PLANS_TABLE_SQL = "CREATE TABLE $PLANS_TABLE_NAME ( id INTEGER PRIMARY KEY AUTOINCREMENT, " +
                ...
                "moved INTEGER, new_plan_id INTEGER, spent_time_before_move INTEGER, spent_time_before_pause INTEGER);"
